...
Component.register('moorl-merchant-finder-list', {
    ...
    methods: {
        ...
        getList() {
            ...
            this.moorlMerchantRepository.search(criteria, this.context).then((items) => {
        ...
        prepareSaveItem(item) {
            ...
            if (item.originId && this.csv.options.overwrite) {
                ...
                this.moorlMerchantRepository
                    .search(merchantCriteria, this.context)
                    .then((result) => {
                        if (result.length == 0) {
                            result = this.moorlMerchantRepository.create(this.context);
                ...
                let result = this.moorlMerchantRepository.create(this.context);
                Object.assign(result, item);
                this.saveItem(result);
            }
